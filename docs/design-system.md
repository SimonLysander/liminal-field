...
- **2026-05-23** 确立 **Notion 紧凑尺寸基准**(照 Notion DOM 实测):控件高 **28px**(sm 24)、图标 **20**(按钮内 18)、字号 主 **14** / 次·快捷键 **12**、圆角 控件 `sm` · 浮层 `xl`、**1px 细边**、菜单项行高 **28**、浮层宽 **~256**。Button / Input 已按此重做;菜单 / 就近浮层组件待建。
